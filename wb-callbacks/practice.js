...
let contains = (array, name, callback) => {
...
let startWithLetterA = (arr) => {
  return arr.filter((strings) => {
    return strings[0] === 'A' || strings[0] === 'a'
  })
}
...
const sortMenuItems = orders.map(order => order.sort(price))
